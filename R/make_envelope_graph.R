...
make_envelope_graph = function( envelope, t0, ylab = "Y", xlab="month" ) {
  ...
  if ( has.smooth ) {
    ...
    plt = plt + ggplot2::geom_line( data=dplyr::filter( envelope, .data$time >= t0 ), 
